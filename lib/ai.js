...
export async function generateChoreAssignments(familyMembers, unassignedChores) {
  const prompt = `You are a family planner assistant. Given the following family members and unassigned chores, suggest fair and practical chore assignments considering balance and preferences.
